...
from framework_is31fl3743.led_glasses_map import (
...
# Initalize the IS31FL3743
is31 = framework_is31fl3743.IS31FL3743(i2c=i2c)

# Initialize the IS31FL3743 displayio display
is31_fb = framework_is31fl3743.IS31FL3743_FrameBuffer(
    width=54,
    height=15,
    is31=is31,
    scale=True,
...
eye_left = IS31FL3743_PixelBuf(
    is31, left_ring_map_no_inner, init=False, auto_write=False
)
eye_right = IS31FL3743_PixelBuf(
